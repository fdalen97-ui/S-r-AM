...
*Totalplanen for alle tre landene. **Utreisen er nå en ekte, betalt billett**
(se boksen under) — ikke lenger en anbefaling. **Designlogikken:** TH–KH-
grensen er stengt → ruten går én vei østover med bare ETT fly midtveis,
alle andre etapper er buss/båt over åpne grenser. Alle priser i NOK.*

## 🎫 UTREISEN ER BOOKET — PNR 8DHUIF

*Bekreftet 17. sept 2026, betalt med Lisa sitt Mastercard.*

| | |
|---|---|
| **Onsdag 30. des**, Oslo 09:00 → Doha 17:30 | QR180, Boeing 787-8, 6t30 |
| Opphold Doha | 2t30 |
| Doha 20:00 → **Bangkok, torsdag 31. des kl. 06:15** | QR830, Boeing 787-9, 6t15 |
| Bagasje | 25 kg per person inkludert |
| Seter | Lisa 32A+38K · Fredrik 32B+38J — sammen på begge ben |
| Pris | 13 906 kr for to (12 234 fly + 1 672 setevalg) |

**Dette er 5 dager senere enn den forrige låste planen (25./26. des).**
Fujii Kaze var uansett avlyst, så konsert-tapet er null — men **hele
dagsplanen under er regnet om** fra denne ankomsten, ikke den gamle.

⚠️ **Handling nødvendig:** [`utreise-oslo-bangkok.md`](utreise-oslo-bangkok.md)
og [`sjekkliste-for-avreise.md`](sjekkliste-for-avreise.md) anbefalte
fortsatt 25. desember da denne ble booket — begge er nå oppdatert til å vise
denne billetten som fasit.

## 🔒 LÅST DAGSPLAN — regnet fra ankomst 31. desember

### 🧮 Hvorfor dagene er strammere enn før

**Zamna Phuket (23.–24. jan) er en fast festivaldato som ikke flytter seg**
med avreisen. Fra gammel ankomst (26. des) til Khao Lak-starten (19. jan)
var det 24 netter å bruke. Fra ny ankomst (31. des) er det bare **19 netter**
til samme frist. **5 netter må derfor kuttes** i Bangkok/Chiang Mai/Kambodsja
for at Zamna og Similan-liveaboarden (uendret, i toppsesong) fortsatt skal
holde. Kuttene er spredt tynt — ingen stopp mister hovedopplevelsen sin, alle
mister én dag med luft rundt den.

### 🌄 Blokk 1 — Bangkok og nord (31. des – 11. jan · 11 netter, var 13)
...
| **lør 2. jan** | Bangkok | Chatuchak 09–11 · 🧳 flytt 12:00 til ASAI Chinatown (Loy La Long har bare 31.12 + 1.1) · Talat Noi · 🍣 **19:00 Omakase** (Masato — sjekk 14. okt at 2. jan er åpen) · Bamboo Bar |
...
| **tor 7. jan** | 🚗 **MHS-loopen dag 1** | Doi Inthanon → Mae Chaem → rute 1263 → **Khun Yuam** |
| fre 8. jan | Loopen dag 2 | Mae Hong Son by, Doi Kong Mu → **Ban Rak Thai** |
| lør 9. jan | Loopen dag 3 | 🌅 **Pang Oung i grålysningen** → Tham Lod → **Cave Lodge** (🦇 seilerne ved skumring) |
| søn 10. jan | Loopen dag 4 | 🌅 **Ban Jabo-skyhavet** → Pai |
| **man 11. jan** | 🌅 Doi Kiew Lom 05:30 → Chiang Mai → ✈️ | Levere bil, CNX→BKK→REP på **én Bangkok Airways-PNR** |

*Kuttet mot gammel plan: Bangkok 4→3 netter, Chiang Mai 4→3 netter.
Nyttårsaften flyttes fra Chiang Mai-lanterner til Bangkok-countdown — sjekk
om Tha Phae Gate-lanterner kjøres andre kvelder enn 31/12 hvis dere vil ha
begge deler.*

### 🛕 Blokk 2 — Kambodsja (11.–18. jan · 7 netter, var 10)

| Dato | Sted | Dagen |
|---|---|---|
| man 11. – ons 13. jan | **Siem Reap** (2 n) | Angkor i soloppgang + liten runde, Phare-sirkuset |
| **ons 13. jan** | 🚌 Giant Ibis dagbuss | 6 t |
| ons 13. – tor 14. jan | **Phnom Penh** (1 n) | S-21 + Choeung Ek som fokusert halvdag, palasset |
| **tor 14. jan** | 🚌 Giant Ibis | 4 t |
| tor 14. – lør 16. jan | **Kampot/Kep** (2 n) | Pepperfarm, krabbemarkedet |
| **lør 16. jan** | 🚌 2 t + ⛴️ 1 t | Via Sihanoukville |
| lør 16. – man 18. jan | **Koh Rong Samloem** (2 n) | Sunset Beach, **Koh Tang-turen** |
| **man 18. jan** | ⛴️+🚌 PP + ✈️ BKK | **Mellomnatt i Bangkok — obligatorisk**, aldri øy→fly samme dag |

*Kuttet mot gammel plan: Siem Reap 3→2, Phnom Penh 2→1, Koh Rong Samloem
3→2. Kampot/Kep uendret (2 n) — den korteste dagsplanen fra før, ikke mer å
hente der uten å droppe en av de to hovedaktivitetene.*

### 🐠 Blokk 3 — Andaman-finalen (18.–29. jan · 11 netter, **uendret**)

*Disse datoene rører seg ikke — de er allerede regnet ut fra Zamna og
Similan-sesongen, ikke fra avreisedatoen, så 5-dagers-forsinkelsen treffer
dem ikke.*
...
| man 25. – tor 29. jan | **Koh Yao Noi** (4 n) | Speedbåt fra Bang Rong · dekompresjonen |
| **tor 29. jan** | ✈️ **HKT–OSL direkte (Norse)** | 🏁 **31 dager fra avreise — 4 dager buffer under 5-ukersgrensen** |

### 🍷 Blokk 4 — kun ved lengre tur (29. jan – 5. feb · 7 netter)

| Dato | Sted | Dagen |
|---|---|---|
| tor 29. jan – man 1. feb | **Bangkok** (4 n) | 🎸 **Bangkok Music City 30.–31. jan** · siste omakase |
| man 1. – tor 4. feb | **Khao Yai** 🍷 (3 n) | Leiebil 2,5 t · **GranMonte i innhøsting** |
| **tor 5. feb** | ✈️ BKK–OSL direkte | 🏁 **38 dager fra avreise** |

### ⚖️ Den ekte femukersgrensen fra 30. desember

**35 dager fra 30. desember er 2. februar, ikke 28./29. januar.** Det betyr
noe fint: Blokk 3 slutter naturlig 29. januar — **31 dager, med 4 dagers
buffer** dere ikke hadde i den gamle planen. Den bufferen kan brukes til
å legge til en ekstra netter et sted i Blokk 1–3 (t.d. Koh Yao Noi 4→5
netter) uten å røre feriekompensasjonen.

**Blokk 4 koster fortsatt feriekompensasjonen** (20 000 kr) — 5. februar er
38 dager, 3 over grensen. Se [`forsikring-og-rettigheter.md`](forsikring-og-rettigheter.md).

### 📋 Bookingrekkefølgen — oppdaterte datoer
...
## 🥇 Logikken bak rekkefølgen — «Nord først, Andaman sist»

![Kart over anbefalt rute med alternativer](../kart/storrunden.svg)

*Kartet viser hovedruta (stopp 1–10), blokk 4 i oransje (kun ved lengre tur),
Saigon-varianten i lilla, og Phu Quoc som utgått.*

Tre harde fakta låser rekkefølgen — uendret av den nye avreisedatoen:
...
2. **Brennesesongen i nord bygger seg opp fra slutten av januar** og topper
   i mars. Chiang Mai og Mae Hong Son **må derfor ligge tidlig** — 7.–11. jan
   er trygt.
3. **CNX→HKT går direkte**, og **HKT–OSL og BKK–OSL går direkte med Norse**.
   Begge ender er løst uten mellomlanding.

**Konsekvens: nord i begynnelsen, Kambodsja i midten, Andaman til slutt.**
Se den fullstendige, dagsatte planen over — blokkene der er de samme fire
som beskrives i prinsippet her, bare med ekte datoer og de nødvendige
kuttene fra den fem dager senere avreisen.

### 📏 Stigen: hva hver ekstra uke faktisk kjøper (fra 30. des-avreise)

| Hjemreise | Dager fra avreise | Legger til | Hovedhaken |
|---|---|---|---|
| **29. jan** | 31 dager | Grunnruta: Bangkok · nord · Kambodsja · Andaman | 4 dager buffer under 5-ukersgrensen |
| **5. feb** | 38 dager | Khao Yai-innhøsting + Bangkok Music City | Mister feriekompensasjonen (3 dager over) |
| **12. feb** | 45 dager | Sør-Laos: Pakse + Bolaven-platået | Krever at januar bygges om — *ikke rekalkulert etter ny avreisedato ennå* |
| **19. feb** | 52 dager | + Sør-Vietnam (Saigon, Mekong, Dalat/Con Dao) | Går rett gjennom Tet |

Forsikringen holder hele veien — hoveddekningen går til **10 uker (70 d)**.

⚠️ **7- og 8-ukersvariantene under er ikke omregnet etter den nye
avreisedatoen** — de brukte 26. des som utgangspunkt for Nordblokka. Hvis
dere vurderer å strekke turen så langt, si ifra, så regner jeg om resten av
kabalen (Laos-blokka må trolig krympe 2–3 netter for at Khao Lak/Zamna
fortsatt skal stemme).

### 🧨 Tet og kinesisk nyttår: **6. februar 2027**

Begge faller på samme dag i 2027. Lovfestet helligdag i Vietnam **5.–9.
februar**, og regjeringen utvider den vanligvis til 7–9 dager. Dette er den
harde datoen i enhver 7–8-ukersplan:

- 🇻🇳 **Vietnam:** transport utsolgt og oppriset, mange restauranter og
  butikker stengt i dagevis. **Regelen er å være ett sted og ikke flytte seg
  4.–10. februar.** Saigon på nyttårsaften er til gjengjeld storslått.
- 🇹🇭 **Thailand:** ingen helligdag, men **Yaowarat i Bangkok på kinesisk
  nyttår er en av Asias beste gateopplevelser.**
...
**Visum holder hele veien:** Thailand 60 døgn visumfritt per innreise,
Laos visum ved ankomst 30 døgn, Kambodsja e-visum 30 døgn, Vietnam e-visum
90 døgn.
...
**SGN→HKT direkte** rett inn i Andaman-blokka. Null overlandssmerte. Prisen
er tre netter som må tas fra Kambodsja eller Koh Yao Noi.

---

## 🆕 Forrige versjon (aug.–sept. 2026): Andaman-finalen fra 26. des-ankomst

*⚠️ Erstattet av ruta over etter at billetten ble booket 5 dager senere enn
planlagt. Beholdt som referanse for logikken (den er fortsatt riktig — bare
datoene i Blokk 1–2 er utdaterte).*

Festival- og snorkelresearchen flyttet konklusjonen fra Phu Quoc-finale til
Andaman-finale: **Zamna Phuket er bekreftet**, snorkel-sesongen (Similan)
er perfekt i slutten av januar, og dramaturgien Koh Koun → Koh Tang →
Similan blir riktig som crescendo.

*Fullstendig gammel dagsplan med 26.-des-datoer er fjernet herfra for å
unngå forveksling med planen over — spør om du vil se den igjen.*
...
| Bangkok → Siem Reap | ✈️ AirAsia/Bangkok Airways fra DMK | 500–800 | **Finnes ikke landeveien** (grensen stengt) | **Tuk-tuk-sjåfør Angkor** — bedre enn scooter i tempelvarmen |
| Siem Reap → Phnom Penh | 🚌 Giant Ibis dagbuss 6 t (~150 kr) | Privat sjåfør delt (~500 kr for to) | **Ikke nattbuss her** | PassApp (Kambodsjas Grab) |
| Phnom Penh → Kampot | 🚌 Buss/minivan 4 t (~150 kr) | 🚂 Royal Railway-toget (helg) | — | 🛵 Kampots landsbygd er scooterterreng, men kun med MC-førerkort + IDP; ellers tuk-tuk-dagstur ~260 kr |
| Kampot/Kep → Sihanoukville → Samloem | 🚐 2 t + ⛴️ 1 t | — | Book ferge dagen før i høysesong | — |
| Samloem → Phnom Penh → Bangkok | ⛴️+🚌 + ✈️ | — | **Mellomnatt i Bangkok obligatorisk** | — |
| Chiang Mai → Siem Reap | ✈️ CNX→BKK→REP, én PNR | — | — | — |
| Khao Lak → Phuket → Koh Yao Noi | 🚗 1 t + ⛴️ 45 min | — | — | — |
| Phuket → Oslo | ✈️ HKT–OSL direkte (Norse) | — | — | — |
...
- **Med MC-kort:** Kampot-landsbygda er turens beste scooter-stopp på denne
  ruta. Siem Reap/Angkor: tuk-tuk uansett — skygge og lokalkunnskap inkludert.
- **Uten MC-kort:** tuk-tuk-dagsturer, Grab/PassApp dekker alt — dere
  mister ingenting av ruten.
...
eventer: [`festivaler-og-eventer.md`](festivaler-og-eventer.md) · omakase:
[`omakase.md`](omakase.md) · snorkling: [`snorkling-kh-vn.md`](snorkling-kh-vn.md)*
